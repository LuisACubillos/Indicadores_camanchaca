---
title: "Indicadores biológico-pesqueros de langostino colorado y langostino amarillo (Marzo 2024)"
author: "Bol. Tec 9(1) | Lab. EPOMAR UdeC – Camanchaca SA"
format: pdf
toc: true
...
```{r echo=FALSE,fig.cap="Distribución espacial del total de lances de pesca realizados durante marzo de 2024.", out.width="70%",fig.align = 'center'}
...
```{r echo=FALSE, fig.cap="Distribución espacial de los lances de pesca orientados a langostino colorado, langostino amarillo y camarón nailon durante marzo de 2024.", out.width="70%",fig.align = 'center'}
knitr::include_graphics("Figuras/Lances_esp-marzo_2024.jpeg")
```

Durante marzo las capturas por lance de langostino colorado fluctuaron entre 48 y 5472 kg, totalizando una captura de 107320 kg. Se logró un promedio de 2283 kg por lance de pesca, desplegando 54 horas de arrastre (h) y un rendimiento de pesca de 2003 kg/h (Tabla 1).
...
El rendimiento de pesca de langostino colorado fluctúo entre 42 y 6221 kg/h, con una moda en 1674 kg/h. En cambio, el esfuerzo de pesca fluctúo entre 23 y 116 minutos, con una mayor frecuencia en 68 minutos (Fig. 3). En cuanto a langostino amarillo, presentó un rendimiento entre los 25 y 5510 kg/h, y el esfuerzo tuvo una mayor frecuencia en 67 min (Fig. 3), y el camarón nailon presentó un rendimiento medio de 336 kg/h  con un esfuerzo entorno a las 2 horas 40 minutos.

```{r echo=FALSE,fig.cap="Distribución de frecuencia del esfuerzo de pesa, en términos de duración del lance en horas de arrastre (ha) (A) y del rendimiento de pesca (kg/h) (B), de langostino colorado, langostino amarillo y camarón nailon en marzo de 2024.", out.width="70%",fig.align = 'center'}
knitr::include_graphics("Figuras/ESF_REND_MAR.png")
```

En cuanto a la distribución espacial del rendimiento de pesca, durante el mes de marzo destacó una zona de alto rendimiento de langostino colorado localizada a la cuadra del W. de Itata, con rendimientos entre los 2500 y >7500 kg/h (Fig. 4). El langostino amarillo se capturó en su mayoría en conjunto con langostino colorado, y presentó los mayores rendimientos en la cuadra del W. de Itata, con rendimientos entre los 2500 y 7500 kg/h (Fig. 4). El rendimiento de pesca fue mayor en un 90% con relación con igual periodo 2023. En cuanto a camarón nailon, este recurso presentó los mayores rendimientos en los caladeros de Chanco y Nugurue con valores entre los 100 y 2500 kg/h (Fig. 5).

```{r echo=FALSE, fig.cap="Distribución del rendimiento de pesca (kg/ha) de langostino colorado, langostino amarillo y camarón nailon en marzo de 2024.", out.width="90%",fig.align = 'center'}
knitr::include_graphics("Figuras/CPUE_marzo_2024.jpeg")
```


```{r echo=FALSE,fig.cap="Rendimiento de pesca (captura por hora de arrastre) anual de langostino colorado (A), langostino amarillo (B) y camarón nailon (C), en los caladeros visitados de en la unidad de pesquería sur, marzo de 2024.", out.width="70%",fig.align = 'center'}
...
```{r echo=FALSE,fig.cap="Proporción sexual de langostino colorado (A), langostino amarillo (B) y camarón nailon durante marzo de 2024.", out.width="90%",fig.align = 'center'}
...
```{r echo=FALSE, fig.cap="Talla promedio (LC, mm) de langostino colorado y langostino amarillo por sexo, en el periodo enero 2016 a marzo de 2024.", out.width="50%",fig.align = 'center'}
...
|         |Madura|0%|
| Total n° |        |55|
| Camarón |Portadoras|7%|
|            |Inmaduras|93%|
| Total n° |    |1540|



```{r echo=FALSE, fig.cap="Comparación de hembras ovígeras de langostino colorado (panel superior) y langostino amarillo (panel inferior), entre los años 2017 a marzo del año 2024.", out.width="60%",fig.align = 'center'}
...
```{r echo=FALSE, fig.cap="Composición de tallas de langostino colorado entre sexos, en marzo de 2024.", out.width="50%",fig.align = 'center'}
knitr::include_graphics("Figuras/frec_colorado_sexo_marzo.jpg")
```



```{r echo=FALSE,fig.cap="Composición de tallas de langostino amarillo entre sexos, en marzo de 2024.", out.width="50%",fig.align = 'center'}
knitr::include_graphics("Figuras/frec_amarillo_zona_marzo.jpg")
```



```{r echo=FALSE,fig.cap="Composición de tallas de camarón nailon entre sexos, en marzo de 2024.", out.width="50%",fig.align = 'center'}
knitr::include_graphics("Figuras/LC_ZONAS_CAMARON_marzo.jpg")
```



```{r echo=FALSE,fig.cap="Composición de tallas de langostino colorado en la UPS por zonas de pesca en marzo de 2024.", out.width="80%",fig.align = 'center'}
...
```{r echo=FALSE, fig.cap="Relación longitud-peso de langostino colorado (A), langostino amarillo (B) y camarón nailon (C), por sexos, en marzo 2024.", out.width="90%",fig.align = 'center'}
...
En cuanto al aporte de otros recursos como fauna acompañante, la merluza común se extrajo en los caladeros de Chanco y Nugurue, con valores entre los 5 y 25 kg/h. El lenguado de ojos grandes se registró en el caladero de Itata, con una captura de entre 15 y rendimiento de 50 kg/h (Fig. 15).
...
```{r echo=FALSE,fig.cap="Distribución de los lances de pesca con captura de pejerrata en las capturas de camarón nailon, langostino colorado y langostino amarillo, y la fracción de pejerrata en las capturas totales, desde marzo  año 2024.", out.width="90%",fig.align = 'center'}
knitr::include_graphics("Figuras/pejerrata_marzo_2024_zoom.jpeg")
```


```{r echo=FALSE, fig.cap="Distribución espacial y abundancia de la fauna acompañante en los lances de pesca orientados a langostinos colorado y langostinos amarillos por la flota arrastrera de Camanchaca Pesca Sur, marzo de 2024.", out.width="90%",fig.align = 'center'}
