...
En marzo de 2024, los de lances de pesca estuvieron orientados a camarón nailon,con el 78,5 % de los lances contituidos por esta especie, luego el 1,1 % de los lances presento solo langostino colorado y el 0,6% langostino amarillo de forma exclusiva, y en el 19,6% de las capturas se presento de forma conjunta langostino amarillo y colorado (Fig. 2). 
...
En camarón nailon se se presentó un % de hembras portadoras predominando las hembras sin huevo (Tabla 3).
...
|         |Madura|0%|
|Total n°|        |55|
|**Camarón nailon**|Portadoras| |
|            |Inmaduras|  |
|Total n°|    |   |

## Composición de tallas

La comparación de tallas de langostino colorado,  y camarón nailon no muestran diferencias significativas entre sexos (t-Student p >0,05), en el primer caso la talla media es de 33 mm Lc y en el segundo es de 28 mm  (Tabla 2, Fig. 9, 11), a diferencia de langostino amarillo este recurso si presenta diferencias significativas entre sexos siendo los machos mas grandes en relacion a las hembras (38 mm, 30 mm LC) (Tabla 2, Fig. 10). El análisis de la composición de tallas por zonas de pesca de langostino colorado mostró las tallas modales más pequeñas el caladero de Tumbes, en tanto las tallas mas grandes se presentaron al W. de Itata (Fig. 12), no se pudo efectuar este analisis en los otros recursos debido a que el muestreo biologico se realizo con muestras provenientes de un solo caladero, el caladero de Tumbes en langostino amarillo y Nugurue en el caso de camarón nailon (Fig. 10, 11).
...
En marzo, la captura se realizó desde la region del Biobío a la región de Maule, y fue dirigida a camarón nailon con 132 lances de pesca, lográndose una captura total de 143052 kg. En tanto, langostino colorado se presentó en 47 lances y alcanzó una captura total de 107320 kg, y lagostino amarillo se capturó mayormente en forma conjunta con langostino colorado totalizando 29874 kg en 34 lances.
...
En langostino colorado hubo presencia de un 20% de hembras en estado ovigero, situacion que no se observaba desde los años 2017-2018 lo que nos podria indicar un adelanto de la actividad rerpoductiva este año, hipotisis a evaluar con los resultados del proximo mes. A su vez los indicadores biologicos muestran una disminucion en la talla media tanto en langostino colorado como langostino amarillo, tallas que incluso en langostino colorado dejan de diferenciarse por sexos, hay que evaluar como continuan las tallas los siguentes meses ya que los resultados que se presentan en este informe provienen de un bajo número de muestras, como consecuencia de una captura dirigeda a camarón nailon, lo que hace que no sean del todo concluyentes.
